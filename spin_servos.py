...
def main():
    ...
    gantry = Gantry(long_motor,short_motor)

    short_motor.find_home()
    long_motor.find_home()
    time.sleep(1)
    short_motor.set_velocity_limit(20)
    long_motor.set_velocity_limit(20)
    short_motor.set_pid(p=35,i=0,d=0.8)
